 ...
 *
 * This class encapsulates the identification of a servo and the requested
 * position (in ticks) that the controller should move it to. It is used by the
 * creature controller to store and process movement requests.
 */
class ServoPosition {
  ...
  public:
    ...
    /**
     * @brief Generates a human-readable string describing this servo move
     * request.
