...
namespace creatures {
     ...
     *
     * This is used to abstract out the logger to allow for different implementations,
     * to to allow for unit testing without needed to depend on the global namespace.
     */
    class Logger {
