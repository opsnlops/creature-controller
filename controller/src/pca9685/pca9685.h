...
/*
 * This file is inspired from Adafruit's PWMServerDriver package. The Adafruit version is designed
 * for Adruino.
 *
 * Here's Adafruit's original license:
 *
 * *************************************************************************************
 *
 ...
 *  *************************************************************************************
 *
 *  Please support Adafruit, they make amazing products! 💜
 */
