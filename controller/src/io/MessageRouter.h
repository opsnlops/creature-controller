...
enum MotorHandlerState { unknown, idle, awaitingConfiguration, configuring, ready, running, stopped };
...
class MessageRouter : public StoppableThread {
  public:
    ...
    ~MessageRouter() override { this->logger->info("MessageRouter destroyed"); }
